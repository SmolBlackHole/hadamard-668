...
CONFIGS = [
    ...
    AblationConfig("legacy-all-on", SolverConfig(
        pairs=True, triples=True, kick=True, restart=True, rescue_mode=True)),
    AblationConfig("+restarts", SolverConfig(
        pairs=True, kick=True, restart=True)),
]
...
def main() -> None:
    ...
    by_config: dict[str, dict[int, list[dict[str, Any]]]
